...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function jo(){return new Qt({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:xa(),fragmentShader:`
		...
		`,blending:xn,depthTest:!1,depthWrite:!1})}function Ko(){return new Qt({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xa(),fragmentShader:`
...
`)}function Nm(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function es(i){return i!==""}function sc(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function rc(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Um=/^[ \t]*#include +<([\w\d./]+)>/gm;function aa(i){return i.replace(Um,Fm)}const Om=new Map;function Fm(i,e){let t=Le[e];if(t===void 0){const n=Om.get(e);if(n!==void 0)t=Le[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return aa(t)}const Bm=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ac(i){return i.replace(Bm,zm)}function zm(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function oc(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function km(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Vc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Yl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===pn&&(e="SHADOWMAP_TYPE_VSM"),e}function Hm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ri:case Ci:e="ENVMAP_TYPE_CUBE";break;case tr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Vm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ci:e="ENVMAP_MODE_REFRACTION";break}return e}function Gm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Gc:e="ENVMAP_BLENDING_MULTIPLY";break;case xh:e="ENVMAP_BLENDING_MIX";break;case Mh:e="ENVMAP_BLENDING_ADD";break}return e}function Wm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Xm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=km(t),l=Hm(t),h=Vm(t),u=Gm(t),d=Wm(t),m=Im(t),g=Dm(r),v=s.createProgram();let p,f,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(es).join(`
`)),a=aa(a),a=sc(a,t),a=rc(a,t),o=aa(o),o=sc(o,t),o=rc(o,t),a=ac(a),o=ac(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`;continue}if((Y=X.match(x))&&(k.gamma=parseFloat(Y[1])),(Y=X.match(I))&&(k.exposure=parseFloat(Y[1])),(Y=X.match(G))&&(k.valid|=2,k.format=Y[1]),(Y=X.match(C))&&(k.valid|=4,k.height=parseInt(Y[1],10),k.width=parseInt(Y[2],10)),k.valid&2&&k.valid&4)break}return k.valid&2||a(3,"missing format specifier"),k.valid&4||a(3,"missing image size specifier"),k},m=function(L,S,x){const I=S;if(I<8||I>32767||L[0]!==2||L[1]!==2||L[2]&128)return new Uint8Array(L);I!==(L[2]<<8|L[3])&&a(3,"wrong scanline width");const G=new Uint8Array(4*S*x);G.length||a(4,"unable to allocate buffer space");let C=0,k=0;const X=4*I,Y=new Uint8Array(4),J=new Uint8Array(X);let W=x;for(;W>0&&k<L.byteLength;){k+4>L.byteLength&&a(1),Y[0]=L[k++],Y[1]=L[k++],Y[2]=L[k++],Y[3]=L[k++],(Y[0]!=2||Y[1]!=2||(Y[2]<<8|Y[3])!=I)&&a(3,"bad rgbe scanline format");let ee=0,Z;for(;ee<X&&k<L.byteLength;){Z=L[k++];const Se=Z>128;if(Se&&(Z-=128),(Z===0||ee+Z>X)&&a(3,"bad scanline data"),Se){const Ne=L[k++];for(let q=0;q<Z;q++)J[ee++]=Ne}else J.set(L.subarray(k,k+Z),ee),ee+=Z,k+=Z}const ue=I;for(let Se=0;Se<ue;Se++){let Ne=0;G[C]=J[Se+Ne],Ne+=I,G[C+1]=J[Se+Ne],Ne+=I,G[C+2]=J[Se+Ne],Ne+=I,G[C+3]=J[Se+Ne],C+=4}W--}return G},g=function(L,S,x,I){const G=L[S+3],C=Math.pow(2,G-128)/255;x[I+0]=L[S+0]*C,x[I+1]=L[S+1]*C,x[I+2]=L[S+2]*C,x[I+3]=1},v=function(L,S,x,I){const G=L[S+3],C=Math.pow(2,G-128)/255;x[I+0]=Es.toHalfFloat(Math.min(L[S+0]*C,65504)),x[I+1]=Es.toHalfFloat(Math.min(L[S+1]*C,65504)),x[I+2]=Es.toHalfFloat(Math.min(L[S+2]*C,65504)),x[I+3]=Es.toHalfFloat(1)},p=new Uint8Array(e);p.pos=0;const f=d(p),T=f.width,E=f.height,A=m(p.subarray(p.pos),T,E);let N,R,b;switch(this.type){case bt:b=A.length/4;const L=new Float32Array(b*4);for(let x=0;x<b;x++)g(A,x*4,L,x*4);N=L,R=bt;break;case _n:b=A.length/4;const S=new Uint16Array(b*4);for(let x=0;x<b;x++)v(A,x*4,S,x*4);N=S,R=_n;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:T,height:E,data:N,header:f.string,gamma:f.gamma,exposure:f.exposure,type:R}}setDataType(e){return this.type=e,this}load(e,t,n,s){function r(a,o){switch(a.type){case bt:case _n:a.colorSpace=mt,a.minFilter=ft,a.magFilter=ft,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,s)}}const $_={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class ar{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const J_=new sr(-1,1,1,-1,0,1);class Q_ extends Gt{constructor(){super(),this.setAttribute("position",new Vt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Vt([0,2,0,0,2,0],2))}}const e0=new Q_;class t0{constructor(e){this._mesh=new wt(e0,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,J_)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class Pl extends ar{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof Qt?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=fl.clone(e.uniforms),this.material=new Qt({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new t0(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class kc extends ar{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class n0 extends ar{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class i0{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new ve);this._width=n.width,this._height=n.height,t=new Bn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_n}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Pl($_),this.copyPass.material.blending=xn,this.clock=new e_}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}kc!==void 0&&(a instanceof kc?n=!0:a instanceof n0&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new ve);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class s0 extends ar{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ye}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor)),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const r0=document.getElementById("canvas");var Fi=new Eg,Zt=new Et(80,window.innerWidth/window.innerHeight,.1,1e3),or=new yg({canvas:r0,antialias:!0});or.setSize(window.innerWidth,window.innerHeight);Zt.position.set(0,10,-50);new Z_().setDataType(bt).load("asset3D/hdr_sky.hdr",function(i){i.encoding=void 0;const e=new ra(or);e.compileEquirectangularShader();const t=e.fromEquirectangular(i).texture;t.format=Ot,Fi.environment=t,i.dispose(),Fi.background=t});const rn=new K_(Zt,or.domElement);rn.enableDamping=!0;rn.dampingFactor=.25;rn.enableZoom=!0;rn.enablePan=!1;rn.target.set(0,8,0);rn.minDistance=20;rn.maxDistance=120;var a0=new h_;a0.load("./asset3D/SeabedLamp.glb",function(i){const e=i.scene;e.position.set(0,0,0),e.scale.set(30,30,30),Fi.add(e)},void 0,function(i){console.error(i)});const La=new Ra(16777215,5,80,.5);La.scale.set(10,4,1);La.position.set(0,8,3);Fi.add(La);const Ia=new Ra(16777215,8,80,.5);Ia.scale.set(10,4,1);Ia.position.set(0,8,-4);Fi.add(Ia);var gn=new P(0,8,0),da=new P().copy(Zt.position),o0=da.distanceTo(gn),Hc=0,Ll,fa,cr=!1,zn=!1;function Il(i){Ll=new Oc(Zt.position).to({x:gn.x+i*Math.cos(Hc),y:da.y,z:gn.z+i*Math.sin(Hc)},500).onComplete(()=>{fa=new Oc({angle:0}).to({angle:Math.PI*2},4e3).onUpdate(e=>{var t=e.angle,n=gn.x+i*Math.cos(t),s=gn.z+i*Math.sin(t);Zt.position.set(n,da.y,s),Zt.lookAt(gn)}).repeat(1/0).start()}).start()}Il(o0);const Dl=document.getElementById("music-box");function Nl(i,e){let t=e.parentNode;for(;t!=null;){if(t===i)return!0;t=t.parentNode}return!1}function Da(i){!cr&&!zn&&Il(i)}function Na(){(cr||zn)&&(Ll.stop(),fa&&fa.stop())}function Ul(i){Nl(Dl,i.target)||(cr=!0,Na())}function Ol(i){Nl(Dl,i.target)||(cr=!1,Da(new P().copy(Zt.position).distanceTo(gn)))}document.addEventListener("mousedown",Ul,!1);document.addEventListener("mouseup",Ol,!1);document.addEventListener("touchstart",function(i){zn=!0,i.touches.length>0&&Ul(i.touches[0]),i.touches.length===2&&(zn=!0,Na())},!1);document.addEventListener("touchend",function(i){zn=!1,i.changedTouches.length>0&&Ol(i.changedTouches[0]),i.touches.length===2&&(zn=!1,Da(new P().copy(Zt.position).distanceTo(gn)))},!1);rn.addEventListener("start",function(){zn=!0,Na()});rn.addEventListener("end",function(){zn=!1,Da(new P().copy(Zt.position).distanceTo(gn))});const c0={uniforms:{tDiffuse:{value:null},time:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
