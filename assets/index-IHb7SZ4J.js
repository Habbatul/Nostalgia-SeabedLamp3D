...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function qo(){return new en({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:va(),fragmentShader:`
		...
		`,blending:vn,depthTest:!1,depthWrite:!1})}function Yo(){return new en({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:va(),fragmentShader:`
...
#define LOW_PRECISION`),e}function km(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===zc?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===Yl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===mn&&(e="SHADOWMAP_TYPE_VSM"),e}function Hm(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case wi:case Ri:e="ENVMAP_TYPE_CUBE";break;case tr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Vm(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Ri:e="ENVMAP_MODE_REFRACTION";break}return e}function Gm(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case kc:e="ENVMAP_BLENDING_MULTIPLY";break;case vh:e="ENVMAP_BLENDING_MIX";break;case Mh:e="ENVMAP_BLENDING_ADD";break}return e}function Wm(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Xm(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=km(t),l=Hm(t),h=Vm(t),u=Gm(t),d=Wm(t),m=Im(t),g=Dm(r),x=s.createProgram();let p,f,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const E=T+p+a,A=T+f+o,N=ec(s,s.VERTEX_SHADER,E),R=ec(s,s.FRAGMENT_SHADER,A);s.attachShader(x,N),s.attachShader(x,R),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function b(I){if(i.debug.checkShaderErrors){const G=s.getProgramInfoLog(x).trim(),C=s.getShaderInfoLog(N).trim(),k=s.getShaderInfoLog(R).trim();let X=!0,Y=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(X=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,N,R);else{const J=tc(s,N,"vertex"),W=tc(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
`;continue}if((Y=X.match(v))&&(k.gamma=parseFloat(Y[1])),(Y=X.match(I))&&(k.exposure=parseFloat(Y[1])),(Y=X.match(G))&&(k.valid|=2,k.format=Y[1]),(Y=X.match(C))&&(k.valid|=4,k.height=parseInt(Y[1],10),k.width=parseInt(Y[2],10)),k.valid&2&&k.valid&4)break}return k.valid&2||a(3,"missing format specifier"),k.valid&4||a(3,"missing image size specifier"),k},m=function(L,S,v){const I=S;if(I<8||I>32767||L[0]!==2||L[1]!==2||L[2]&128)return new Uint8Array(L);I!==(L[2]<<8|L[3])&&a(3,"wrong scanline width");const G=new Uint8Array(4*S*v);G.length||a(4,"unable to allocate buffer space");let C=0,k=0;const X=4*I,Y=new Uint8Array(4),J=new Uint8Array(X);let W=v;for(;W>0&&k<L.byteLength;){k+4>L.byteLength&&a(1),Y[0]=L[k++],Y[1]=L[k++],Y[2]=L[k++],Y[3]=L[k++],(Y[0]!=2||Y[1]!=2||(Y[2]<<8|Y[3])!=I)&&a(3,"bad rgbe scanline format");let ee=0,Z;for(;ee<X&&k<L.byteLength;){Z=L[k++];const Se=Z>128;if(Se&&(Z-=128),(Z===0||ee+Z>X)&&a(3,"bad scanline data"),Se){const Ne=L[k++];for(let q=0;q<Z;q++)J[ee++]=Ne}else J.set(L.subarray(k,k+Z),ee),ee+=Z,k+=Z}const ue=I;for(let Se=0;Se<ue;Se++){let Ne=0;G[C]=J[Se+Ne],Ne+=I,G[C+1]=J[Se+Ne],Ne+=I,G[C+2]=J[Se+Ne],Ne+=I,G[C+3]=J[Se+Ne],C+=4}W--}return G},g=function(L,S,v,I){const G=L[S+3],C=Math.pow(2,G-128)/255;v[I+0]=L[S+0]*C,v[I+1]=L[S+1]*C,v[I+2]=L[S+2]*C,v[I+3]=1},x=function(L,S,v,I){const G=L[S+3],C=Math.pow(2,G-128)/255;v[I+0]=Es.toHalfFloat(Math.min(L[S+0]*C,65504)),v[I+1]=Es.toHalfFloat(Math.min(L[S+1]*C,65504)),v[I+2]=Es.toHalfFloat(Math.min(L[S+2]*C,65504)),v[I+3]=Es.toHalfFloat(1)},p=new Uint8Array(e);p.pos=0;const f=d(p),T=f.width,E=f.height,A=m(p.subarray(p.pos),T,E);let N,R,b;switch(this.type){case bt:b=A.length/4;const L=new Float32Array(b*4);for(let v=0;v<b;v++)g(A,v*4,L,v*4);N=L,R=bt;break;case _n:b=A.length/4;const S=new Uint16Array(b*4);for(let v=0;v<b;v++)x(A,v*4,S,v*4);N=S,R=_n;break;default:throw new Error("THREE.RGBELoader: Unsupported type: "+this.type)}return{width:T,height:E,data:N,header:f.string,gamma:f.gamma,exposure:f.exposure,type:R}}setDataType(e){return this.type=e,this}load(e,t,n,s){function r(a,o){switch(a.type){case bt:case _n:a.colorSpace=mt,a.minFilter=ft,a.magFilter=ft,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,s)}}const $_={name:"CopyShader",uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`};class ar{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error("THREE.Pass: .render() must be implemented in derived pass.")}dispose(){}}const J_=new sr(-1,1,1,-1,0,1);class Q_ extends Wt{constructor(){super(),this.setAttribute("position",new Vt([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute("uv",new Vt([0,2,0,0,2,0],2))}}const e0=new Q_;class t0{constructor(e){this._mesh=new wt(e0,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,J_)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}}class wl extends ar{constructor(e,t){super(),this.textureID=t!==void 0?t:"tDiffuse",e instanceof en?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=hl.clone(e.uniforms),this.material=new en({name:e.name!==void 0?e.name:"unspecified",defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this.fsQuad=new t0(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this.fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this.fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this.fsQuad.render(e))}dispose(){this.material.dispose(),this.fsQuad.dispose()}}class Bc extends ar{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){const s=e.getContext(),r=e.state;r.buffers.color.setMask(!1),r.buffers.depth.setMask(!1),r.buffers.color.setLocked(!0),r.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),r.buffers.stencil.setTest(!0),r.buffers.stencil.setOp(s.REPLACE,s.REPLACE,s.REPLACE),r.buffers.stencil.setFunc(s.ALWAYS,a,4294967295),r.buffers.stencil.setClear(o),r.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),r.buffers.color.setLocked(!1),r.buffers.depth.setLocked(!1),r.buffers.color.setMask(!0),r.buffers.depth.setMask(!0),r.buffers.stencil.setLocked(!1),r.buffers.stencil.setFunc(s.EQUAL,1,4294967295),r.buffers.stencil.setOp(s.KEEP,s.KEEP,s.KEEP),r.buffers.stencil.setLocked(!0)}}class n0 extends ar{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}}class i0{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){const n=e.getSize(new xe);this._width=n.width,this._height=n.height,t=new Bn(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_n}),t.texture.name="EffectComposer.rt1"}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name="EffectComposer.rt2",this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new wl($_),this.copyPass.material.blending=vn,this.clock=new e_}swapBuffers(){const e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){const t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){e===void 0&&(e=this.clock.getDelta());const t=this.renderer.getRenderTarget();let n=!1;for(let s=0,r=this.passes.length;s<r;s++){const a=this.passes[s];if(a.enabled!==!1){if(a.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(s),a.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),a.needsSwap){if(n){const o=this.renderer.getContext(),c=this.renderer.state.buffers.stencil;c.setFunc(o.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),c.setFunc(o.EQUAL,1,4294967295)}this.swapBuffers()}Bc!==void 0&&(a instanceof Bc?n=!0:a instanceof n0&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){const t=this.renderer.getSize(new xe);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;const n=this._width*this._pixelRatio,s=this._height*this._pixelRatio;this.renderTarget1.setSize(n,s),this.renderTarget2.setSize(n,s);for(let r=0;r<this.passes.length;r++)this.passes[r].setSize(n,s)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}}class s0 extends ar{constructor(e,t,n=null,s=null,r=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=s,this.clearAlpha=r,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this._oldClearColor=new ye}render(e,t,n){const s=e.autoClear;e.autoClear=!1;let r,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor)),this.clearAlpha!==null&&(r=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==!0&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(r),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=s}}const r0=document.getElementById("canvas");var Oi=new Eg,Gt=new Et(80,window.innerWidth/window.innerHeight,.1,1e3),or=new yg({canvas:r0,antialias:!0});or.setSize(window.innerWidth,window.innerHeight);Gt.position.set(0,10,-50);new Z_().setDataType(bt).load("asset3D/hdr_sky.hdr",function(i){i.encoding=void 0;const e=new ra(or);e.compileEquirectangularShader();const t=e.fromEquirectangular(i).texture;t.format=Ot,Oi.environment=t,i.dispose(),Oi.background=t});const an=new K_(Gt,or.domElement);an.enableDamping=!0;an.dampingFactor=.25;an.enableZoom=!0;an.enablePan=!1;an.target.set(0,8,0);an.minDistance=20;an.maxDistance=120;var a0=new h_;a0.load("./asset3D/SeabedLamp.glb",function(i){const e=i.scene;e.position.set(0,0,0),e.scale.set(30,30,30),Oi.add(e)},void 0,function(i){console.error(i)});const La=new Ra(16777215,5,80,.5);La.scale.set(10,4,1);La.position.set(0,8,3);Oi.add(La);const Ia=new Ra(16777215,8,80,.5);Ia.scale.set(10,4,1);Ia.position.set(0,8,-4);Oi.add(Ia);var jt=new P(0,8,0),da=new P().copy(Gt.position),o0=da.distanceTo(jt),c0=0,Rl,fa,cr=!1,ki=!1;function Cl(i,e){Rl=new Nc(Gt.position).to({x:jt.x+i*Math.cos(e),y:da.y,z:jt.z+i*Math.sin(e)},500).onComplete(()=>{fa=new Nc({angle:e}).to({angle:e+Math.PI*2},4e3).onUpdate(t=>{var n=t.angle,s=jt.x+i*Math.cos(n),r=jt.z+i*Math.sin(n);Gt.position.set(s,da.y,r),Gt.lookAt(jt)}).repeat(1/0).start()}).start()}Cl(o0,c0);const Pl=document.getElementById("music-box");function Ll(i,e){let t=e.parentNode;for(;t!=null;){if(t===i)return!0;t=t.parentNode}return!1}function Il(i,e){return Math.atan2(i.z-e.z,i.x-e.x)}function Dl(i,e){!cr&&!ki&&Cl(i,e)}function Nl(){(cr||ki)&&(Rl.stop(),fa&&fa.stop())}function Ul(i){Ll(Pl,i.target)||(cr=!0,Nl())}function Ol(i){Ll(Pl,i.target)||(cr=!1,Dl(new P().copy(Gt.position).distanceTo(jt),Il(new P().copy(Gt.position),jt)))}document.addEventListener("mousedown",Ul,!1);document.addEventListener("mouseup",Ol,!1);document.addEventListener("touchstart",function(i){ki||i.touches.length>2&&Ul(i.touches[0])},!1);document.addEventListener("touchend",function(i){ki||i.changedTouches.length>2&&Ol(i.changedTouches[0])},!1);an.addEventListener("start",function(){ki=!0,Nl()});an.addEventListener("end",function(){ki=!1,Dl(new P().copy(Gt.position).distanceTo(jt),Il(new P().copy(Gt.position),jt))});const l0={uniforms:{tDiffuse:{value:null},time:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
            vUv = uv;
            gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `},Da=new i0(or),h0=new s0(Oi,Gt);Da.addPass(h0);const Na=new wl(l0);Na.renderToScreen=!0;Da.addPass(Na);function Fl(){requestAnimationFrame(Fl),Na.uniforms.time.value+=.01,an.update(),Y_(),Da.render()}Fl();const pa=[{title:"hisohkah - school rooftop",file:"music/hisohkah - school rooftop - hisohkah.mp3"},{title:"Instupendo - Six Forty Seven",file:"music/Instupendo - Six Forty Seven - Instupendo.mp3"}];let qs=0;const u0=document.getElementById("play-btn"),d0=document.getElementById("pause-btn"),f0=document.getElementById("next-btn"),p0=document.getElementById("song-title"),lr=document.getElementById("audio");function Bl(i){lr.src=pa[i].file,p0.textContent=pa[i].title}function zl(){lr.play()}function m0(){lr.pause()}function kl(){qs=(qs+1)%pa.length,Bl(qs),zl()}lr.addEventListener("ended",kl);u0.addEventListener("click",zl);d0.addEventListener("click",m0);f0.addEventListener("click",kl);Bl(qs);
